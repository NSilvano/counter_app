...
class _$StartedImpl with DiagnosticableTreeMixin implements _Started {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', 'CounterEvent.started'));
  }
...
class _$IncrementEventImpl
    with DiagnosticableTreeMixin
    implements IncrementEvent {
...
class _$DecrementEventImpl
    with DiagnosticableTreeMixin
    implements DecrementEvent {
